				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
						   ...
						   <a class="nav-item nav-link last" href="Login&Signup/login.html"><img src="images/login.png"></a>
                           <a class="nav-item nav-link last" href="Shoppingcart.html"><img src="images/shop_icon.png"></a>
                        </div>
                    </div>
                    </nav>
				</div>
                    ...
                    <form id="orderForm">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 title-1">PHƯƠNG THỨC THANH TOÁN</div>
                            ...
                            <div class="ck1">
                                ...
                                <label for="cb5"></label>
                                Thanh toán trực tiếp khi giao hàng &nbsp; &nbsp; <img class="tooltip_attach" src="images/icon_cham_hoi.svg">
                            ...
                            <div class="ck1">
                                ...
                                <label for="cb7"></label>
                                Thanh toán bằng thẻ quốc tế và nội địa (ATM) &nbsp; &nbsp; <img class="tooltip_attach" src="images/icon_cham_hoi.svg">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 form-group">
                            <div class="ck1">
                                ...
                                <label for="cb8"></label>
                                Thanh toán bằng ví MoMo &nbsp; &nbsp; <img class="tooltip_attach" src="images/icon_cham_hoi.svg"> &nbsp; &nbsp; <img src="images/icon momo-01.svg">
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 main-cart-right">
                <ul class="list-group">
                    ...
                    <li class="list-group-item divider"></li>
                        ...
                        <li class="list-group-item">
                            <button data-href="https://ananas.vn/order-completed/" class="btn btn-cart btn-complete-detail ">HOÀN TẤT ĐẶT HÀNG
                            </button>
                        </li>
                                </ul>
            </div>
                ...
                <div class="footer_section_2">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            ...
                            <div class="image-icon"><img src="images/map-icon.png"><span class="pet_text">85 , Huỳnh Thúc Kháng , Quận 1 , TP Hồ Chí Minh.</span></div>
                        </div>
