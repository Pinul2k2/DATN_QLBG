        ...
        <div class="container mt-4">
                ...
                <div class="container-fliud">
                    <form name="frmsanphamchitiet" id="frmsanphamchitiet" method="post"
                        ...
                        <input type="hidden" name="hinhdaidien" id="hinhdaidien"
                            value="images/Giày/Football Nam Nike/NikeGripknitPhantomGXEliteDynamicFitFG.4.png">
                        ...
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <div class="preview-pic tab-content">
                                    ...
                                    <div class="tab-pane" id="pic-2">
                                        <img
                                            src="images/Giày/Football Nam Nike/NikeGripknitPhantomGXEliteDynamicFitFG.3.png">
                                    </div>
                                    <div class="tab-pane active" id="pic-3">
                                        <img
                                            src="images/Giày/Football Nam Nike/NikeGripknitPhantomGXEliteDynamicFitFG.1.png">
                                    </div>
                                </div>
                            ...
                            <div class="details col-md-6">
                                ...
                                <div class="rating">
                                    ...
                                    <span class="review-no">9551 reviews</span>
                                </div>
                                <p class="product-description">xu hướng của giới trẻ</p>
                                <small class="text-muted">Giá cũ: <s><span>8.000.000 VND</span></s></small>
                                <h4 class="price">Giá hiện tại: <span>6.565.000 VND</span></h4>
            ...
            <div class="card">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                            Đôi giày Nike được phát hành năm 2022 sản phẩm thiết kế đẹp mắt và đang là xu hướng
                        </div>
                    </div>
                </div>
            </div>
