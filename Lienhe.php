                            ...
                            <div class="container">
                                <form action="/action_page.php">
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="Tên" name="Tên">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="SĐT" name="SĐT">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="massage-bt" placeholder="Ghi chú" rows="5" id="comment"
                                            name="Ghi chú"></textarea>
                                    </div>
                                </form>
                            </div>
                            <div class="send_btn">
        ...
        <div class="container">
            <div class="mail_section">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-2">
                        <div class="footer-logo"><img src="images/phone-icon.png"><span class="map_text">(84)991234589
                            </span></div>
                    </div>
